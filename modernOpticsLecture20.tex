...
\begin{equation}\label{eqn:modernOpticsLecture20:10}
u_{00} = \frac{w_0}{w(z)}
\exp
\left(
...
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture20:30}
w^2(z) = w_0^2 \left(
1 + \frac{z^2}{z_0^2}
\right).
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture20:50}
z_0 = \frac{\pi w_0^2}{\lambda}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture20:70}
\inv{R(z)} = \frac{z}{z^2 + z_0^2}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture20:90}
\phi(z) = \Atan\left(
\frac{z}{z_0}
\right).
\end{equation}
...
%\imageFigure{../figures/phy485-optics/modernOpticsLecture20Fig1}{CAPTION.}{fig:modernOpticsLecture20:modernOpticsLecture20Fig1}{0.2}
%
We want to consider the constant curves
%
\begin{equation}\label{eqn:modernOpticsLecture20:150}
...
%
\begin{equation}\label{eqn:modernOpticsLecture20:210}
\ddt{\phi}
= \ddt{z} \ddz{\phi}
...
%
\begin{equation}\label{eqn:modernOpticsLecture20:230}
-i
\ddt{z} \frac{z_0}{z^2 + z_0^2}
...
%
\begin{equation}\label{eqn:modernOpticsLecture20:650}
...
%
\begin{equation}\label{eqn:modernOpticsLecture20:290}
k_{\mathrm{eff}}
%= k_0 - \frac{1}{z_0}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture20Fig5}{Effective Phase velocity.}{fig:modernOpticsLecture20:modernOpticsLecture20Fig5}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture20:310}
\begin{aligned}
u_{lm} &(x, y, z) \\
&\sim \frac{w_0}{w(z)}
\exp
...
Now
%
\begin{equation}\label{eqn:modernOpticsLecture20:390}
u_{lm}
= \frac{c_{lm}}{w(z)} H_l H_m e^{\frac{i k_0 r^2}{2 q}} e^{-i (l + m + 1) \phi}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture20:410}
u_{00}
...
%
\begin{equation}\label{eqn:modernOpticsLecture20:670}
\begin{bmatrix}
y' \\
\alpha'
\end{bmatrix}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture20:690}
y' = A y + B \alpha.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture20:710}
\alpha' = C y + D \alpha.
\end{equation}
\end{subequations}
%
So that
%
\begin{equation}\label{eqn:modernOpticsLecture20:730}
