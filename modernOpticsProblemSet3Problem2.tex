...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:20}
...
Is there {\bf always a standing wave} in the cavity, even off resonance?

Write an expression for the {\bf visibility}, (max-min)/(max+min), of the energy density
...
\(3\) and so forth.
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet3Problem2Fig1}{Internal Fabry-Perot field geometry.}{fig:modernOpticsProblemSet3Problem2:modernOpticsProblemSet3Problem2Fig1}{0.2}
%
...
\begin{equation}\label{eqn:modernOptics:problemSet3:2:60}
\begin{aligned}
\Psi(x)
&=
(\Psi_0 t)
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:80}
\Delta \equiv 2 k L + 2 \delta_r,
\end{equation}
%
we have
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:100}
\Psi(x)
=
...
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:140}
A = \frac{T}{1 + R^2 - 2 \cos(\Delta) }.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:160}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:180}
2 k x - \Delta + \Delta_r = \pi (2 m).
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:200}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:220}
1 + R + 2 \sqrt{R} = (1 + \sqrt{R})^2.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:240}
1 + R - 2 \sqrt{R} = (1 - \sqrt{R})^2.
\end{equation}
\end{subequations}
%
...
\begin{equation}\label{eqn:modernOptics:problemSet3:2:260}
u_{\mathrm{max}}
=
...
\right)^2.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:280}
u_{\mathrm{min}}
=
\frac{u_0 (1 - R) }{1 + R^2 - 2 \cos(\Delta) }
\left(
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet3Problem2Fig2}{peak energy density.}{fig:modernOpticsProblemSet3Problem2:modernOpticsProblemSet3Problem2Fig2}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:320}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:340}
\lambda_{\mathrm{res}}
=\frac{4 \pi L}{
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:440}
u(x)
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:460}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:300}
\calV = \frac
{
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:360}
\Psi_{+}(x)
=
\frac{\Psi_0 \sqrt{T} e^{i \delta_t} }{1 - R e^{ i \Delta} }
e^{i k x}.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:2:380}
\Psi_{-}(x)
=
\frac{\Psi_0 \sqrt{T} e^{i \delta_t} }{1 - R e^{ i \Delta} }
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:400}
\begin{aligned}
\Psi_T
&=
t \Psi_{+}(L) \\
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:2:420}
\begin{aligned}
I_T
&= \Abs{\Psi_T}^2 \\
