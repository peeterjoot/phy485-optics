...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture13:20}
I_t = \frac{I_{\mathrm{max}}}{1 + F \sin^2 \Delta/2}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture13:40}
F = \frac{4 R}{(1 - R)^2}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture13:60}
\Delta = 2 \delta_r + \delta.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture13:80}
...
re-label with
%
\begin{equation}\label{eqn:modernOpticsLecture13:100}
...
%
\begin{equation}\label{eqn:modernOpticsLecture13:120}
...
%
\begin{equation}\label{eqn:modernOpticsLecture13:140}
1 + F\sin^2\frac{\Delta_1}{2} = 2.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture13:280}
\sin\frac{\Delta_1}{2} = \inv{\sqrt{F}}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture13:160}
x = \frac{2}{\sqrt{F}}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture13:180}
\Delta_1 = 2 \pi m + x.
\end{equation}
%
Define, the \underlineAndIndex{Finesse}, as
%
\begin{equation}\label{eqn:modernOpticsLecture13:200}
\calF = \pi \frac{\sqrt{R}}{1 - R} = \frac{\pi}{2} \sqrt{F} \sim \frac{\pi}{T}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture13:220}
\omega_1 - \omega_2 = \frac{2 c}{L \sqrt{F}}
=\frac{\pi c}{L \calF}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture13:240}
...
%
\begin{equation}\label{eqn:modernOpticsLecture13:260}
...
which gives
%
\begin{equation}\label{eqn:modernOpticsLecture13:300}
\Delta = \text{offset} + 2 \frac{\overbar{\omega}}{c} L = 2 \pi (m + j).
\end{equation}
%
Neglecting the offset so that
%
\begin{equation}\label{eqn:modernOpticsLecture13:320}
2 \frac{\overbar{\omega}}{c} L = 2 \pi (m + j).
\end{equation}
%
or
%
\begin{equation}\label{eqn:modernOpticsLecture13:340}
...
%
\begin{equation}\label{eqn:modernOpticsLecture13:360}
\Delta = \frac{2 L}{c} \omega + 2 \delta_r = 2 \pi m.
\end{equation}
%
Here \(\Delta\) is the round trip phase.  Our resonances are
%
\begin{equation}\label{eqn:modernOpticsLecture13:380}
