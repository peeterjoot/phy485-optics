...
Suppose we've shined in two beams of the same frequency, and then slowly start changing the frequency of the other beam, until we get to the point where we've got both peaks centred at \(2 \pi m / \omega_k\) as in \cref{fig:modernOpticsLecture13:modernOpticsLecture13Fig3}.
%
...
%
We'll consider this ``resolved'' when the second peak is centred at the point when our first peak has lost half of its intensity as in \cref{fig:modernOpticsLecture13:modernOpticsLecture13Fig5}.
%
