...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem2Fig1}{Notation for Fresnel lens mask.}{fig:modernOpticsProblemSet2Problem2:modernOpticsProblemSet2Problem2Fig1}{0.1}
%
\makesubproblem{
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:20}
\begin{aligned}
\Psi
&=
\frac{\Psi_\infty}{2 i}
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:100}
\begin{aligned}
\Psi_f
&=
\frac{\Psi_\infty}{2} (1 - i)
...
&\qquad+ C(-u_1) + iS(-u_1) -C(-u_2) - iS(-u_2)
} \\
&=
\Psi_\infty (1 - i)
\left(
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:140}
\theta(u_m)
= \frac{\pi}{2} u_m^2
...
% original logic:
%\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4}{Cornu Spiral with regions blocked for equal phase differences.}{fig:modernOpticsProblemSet2Problem2CornuSpiralMasked:modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4}{0.2}
% fudging the logic:
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4a}{Cornu Spiral with regions blocked for equal phase differences.}{fig:modernOpticsProblemSet2Problem2CornuSpiralMasked:modernOpticsProblemSet2Problem2CornuSpiralMaskedFig4}{0.2}
%
...
\begin{itemize}
\item \( [-u_0, u_0]\):
\begin{equation}\label{eqn:modernOpticsProblemSet2Problem2:380}
\Psi_{f0} = \Psi_\infty (1 - i) \left( C\left(\sqrt{3/2}\right) + i S\left(\sqrt{3/2}\right) \right) .
\end{equation}
\item \( [-u_2, -u_1] \cup [u_1, u_2] \):
\begin{equation}\label{eqn:modernOpticsProblemSet2Problem2:400}
\begin{aligned}
\Psi_{f2} 
= \Psi_\infty (1 - i) 
\Biglr{
&C\left(\sqrt{11/2}\right) - C\left(\sqrt{7/2}\right) \\
&+ i S\left(\sqrt{11/2}\right) - iS\left(\sqrt{7/2}\right)
}
.
\end{aligned}
\end{equation}
\item \( [-u_4, -u_3] \cup [u_3, u_4] \):
\begin{equation}\label{eqn:modernOpticsProblemSet2Problem2:420}
\begin{aligned}
\Psi_{f4} = \Psi_\infty (1 - i) 
\Biglr{ 
&C\left(\sqrt{19/2}\right) - C\left(\sqrt{15/2}\right) \\
&\quad+ i S\left(\sqrt{19/2}\right) - iS\left(\sqrt{15/2}\right) 
}.
\end{aligned}
\end{equation}
\end{itemize}
...
\begin{equation}\label{eqn:modernOpticsProblemSet2Problem2:n}
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:240}
u_m
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem2Fig3}{Geometry for path length interpretation.}{fig:modernOpticsProblemSet2Problem2:modernOpticsProblemSet2Problem2Fig3}{0.2}
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:280}
\begin{aligned}
r_m
&= \sqrt{f^2 + x_m^2} \\
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:300}
\begin{aligned}
\inv{2} (r_2 + r_1) 
&\sim
\inv{2} 
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:320}
\begin{aligned}
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:340}
\begin{aligned}
2 x_0
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:360}
\begin{aligned}
x_{2k} - x_{2k-1}
&\sim (u_{2k} - u_{2k-1} ) \sqrt{ \frac{\lambda f}{2} } \\
&=
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P2:340b}
