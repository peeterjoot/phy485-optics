...
%
\begin{equation}\label{eqn:modernOpticsLecture9:10}
I = I_1 + I_2 + 2 \Real \Gamma_{12}.
\end{equation}
%
where
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture9:30}
I_1 = \expectation{ \Psi_1 \Psi_1^\conj }.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture9:50}
I_2 = \expectation{ \Psi_2 \Psi_2^\conj }.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture9:70}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig1}{Michaelson.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig1}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig2}{Equivalent to Michaelson.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig2}{0.1}
%
With
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture9:90}
\Psi(\Br_k, t) = \sqrt{I(\Br_k)} \exp\left( i \phi(\Br_k, t) \right).
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture9:110}
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:130}
I(\Br_1) \sim I(\Br_2).
\end{equation}
%
and define
...
We write
%
\begin{equation}\label{eqn:modernOpticsLecture9:170}
\gamma_{12} = \frac{\Gamma_{12}}{\sqrt{I_1} \sqrt{I_2}}.
\end{equation}
%
So that our total intensity is just
%
\begin{equation}\label{eqn:modernOpticsLecture9:190}
I = 2 I_1 ( 1 + \Real \gamma_{12} ).
\end{equation}
%
Our task is to calculate
%
\begin{equation}\label{eqn:modernOpticsLecture9:210}
\gamma_{12} = \expectation{ e^{i\phi_1 - i\phi_2} }.
\end{equation}
%
With
%
\begin{equation}\label{eqn:modernOpticsLecture9:230}
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig3}{Random step phase changes.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig3}{0.2}
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig4}{Effect of random phase changes.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig4}{0.2}
%
This isn't necessarily a realistic system, but it one that we can calculate.
%
\begin{equation}\label{eqn:modernOpticsLecture9:250}
\gamma_{12}
= \expectation{ e^{i \phi(t) } e^{ -i\phi(t + \tau) } }
= e^{i \omega \tau} \lim_{T \rightarrow \infty} \int_0^T e^{i \Delta(t) - i\Delta(t + \tau)} dt.
\end{equation}
%
The phase transitions above are illustrated in \cref{fig:modernOpticsLecture9:modernOpticsLecture9Fig5}.
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig5}{Differences of random phases after time delay.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig5}{0.2}
%
Integrating across one time interval and then summing we have
%
\begin{equation}\label{eqn:modernOpticsLecture9:270}
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:410}
e^{i\Delta_1}
+e^{i\Delta_2}
+e^{i\Delta_3}.
\end{equation}
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig7}{Random walk evolution.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig7}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:290}
\gamma_{12} =
\left\{
\begin{array}{l l}
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:310}
\begin{aligned}
I
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig6}{Resulting interference intensity.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig6}{0.2}
%
One fringe is at
%
\begin{equation}\label{eqn:modernOpticsLecture9:330}
\omega \tau = 2 \pi,
\end{equation}
%
or
\begin{equation}\label{eqn:modernOpticsLecture9:350}
\omega \frac{s_2 - s_1}{c} = 2 \pi.
\end{equation}
%
With
%
\begin{equation}\label{eqn:modernOpticsLecture9:370}
2 \pi \frac{c }{\omega} = \frac{\omega \lambda}{\omega} = \lambda.
\end{equation}
%
we have
%
\begin{equation}\label{eqn:modernOpticsLecture9:390}
s_2 - s_1 = \lambda.
\end{equation}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:450}
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:470}
f(x) = g * h = \int_{-\infty}^\infty dx' g(x') h(x - x').
\end{equation}
%
Then
\begin{equation}\label{eqn:modernOpticsLecture9:490}
F(k) = G(k) H(k),
\end{equation}
%
so that
%
\begin{equation}\label{eqn:modernOpticsLecture9:510}
f(x) = \calF^{-1} G(k) H(k).
\end{equation}
%
We see that
...
%
\begin{equation}\label{eqn:modernOpticsLecture9:530}
...
where
%
\begin{equation}\label{eqn:modernOpticsLecture9:550}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture9:570}
G_{12}(\omega) = \lim_{T \rightarrow \infty} \inv{2 T}
V_T(\Br_1, \omega)
V_T^\conj(\Br_2, \omega)
\sim V_1(\omega) V_2^\conj(\omega).
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture9:590}
V(\omega) = \calF(\Psi).
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture9:610}
V_T = \int_{-\infty}^\infty \Psi_T^{(r)} (\Br, t) e^{i \omega t}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture9:630}
\Psi_T^{(r)} =
\left\{
\begin{array}{l l}
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture9Fig9}{Lorentzian power spectrum and correlation.}{fig:modernOpticsLecture9:modernOpticsLecture9Fig9}{0.2}
%
%\vcsinfo
%\EndArticle
