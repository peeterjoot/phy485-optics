...
\imageFigure{../figures/phy485-optics/modernOpticsLecture3Fig1}{Gradium lens.}{fig:modernOpticsLecture3:modernOpticsLecture3Fig1}{0.2}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:470}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:490}
n(\rho) = - \inv{d} \sqrt{f^2 + \rho^2} + n_0 + \frac{f}{d}.
\end{equation}
%
Assuming a paraxial approximation where \(\rho \ll f\) we have
%
\begin{equation}\label{eqn:modernOpticsLecture3:510}
\begin{aligned}
n(\rho)
&= n_0 + \frac{f}{d} \lr{ 1 - \sqrt{1 + \left( \frac{\rho}{f} \right)^2} } \\
&\sim n_0 + \frac{f}{d} \lr{ 1 - \lr{ 1 + \inv{2} \left( \frac{\rho}{f} \right)^2 } } \\
...
We write
%
\begin{equation}\label{eqn:modernOpticsLecture3:530}
\alpha = \inv{ 2 f d },
\end{equation}
%
and seek to solve the Ray equation
%
\begin{equation}\label{eqn:modernOpticsLecture3:550}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:570}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:110}
\Brho(z) =
\begin{bmatrix}
x(z) \\
y(z) \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:130}
\Brho(0) =
\begin{bmatrix}
A \\
C
...
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture3:150}
\evalbar{\ddz{\Brho}}{0} =
\sqrt{\frac{\alpha}{n_0}}
\begin{bmatrix}
B \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:610}
\Brho(z) =
\begin{bmatrix}
B \\
D
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture3Fig4r}{Ray variation with position through GRIN material.}{fig:modernOpticsLecture3:modernOpticsLecture3Fig4r}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:630}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:170}
\begin{aligned}
\tau
...
%
But
\begin{equation}\label{eqn:modernOpticsLecture3:190}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:210}
\tau
...
%
But
\begin{equation}\label{eqn:modernOpticsLecture3:230}
...
%
so
\begin{equation}\label{eqn:modernOpticsLecture3:250}
\tau
= \frac{n_0 L}{c}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:270}
S = \int_{t_1}^{t_2} dt \LL.
\end{equation}
%
where \(\LL\) is the Lagrangian.  We recall Hamilton's principle which states that if
%
\begin{equation}\label{eqn:modernOpticsLecture3:290}
\delta S = 0,
\end{equation}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:410}
...
%
\begin{equation}\label{eqn:modernOpticsLecture3:430}
