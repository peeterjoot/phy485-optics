...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:20}
\BR + \Br' = \Br.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:40}
\BR_s + \Br' = \Br_s.
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:60}
\begin{aligned}
\Abs{\BR}
...
and to first order
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:80}
\begin{aligned}
k\Abs{\BR}
...
%
Similarly
\begin{equation}\label{eqn:modernOptics:problemSet3:3:100}
\begin{aligned}
k\Abs{\BR_s}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:120}
k_y \equiv \frac{2 \pi}{\lambda} \sin\theta,
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:140}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:160}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:180}
...
Let's write
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:200}
\Delta k = k_{y} - k_{y,s},
\end{equation}
%
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:220}
\begin{aligned}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:240}
\begin{aligned}
\Psi
&=
b
...
\end{equation}
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:260}
\Psi \sim
\frac{\sin( \Delta k b/2 )}{ \Delta k b/2}
\frac
{\sin( \Delta k a N/2 )}
...
\begin{equation}\label{eqn:modernOptics:problemSet3:3:300}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:320}
\begin{aligned}
\gamma
&= \frac{\Delta k a}{2} \\
&= \frac{k a}{2} \sin\theta \\
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:340}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:360}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:380}
N \frac{\pi a}{\lambda} \sin\theta = l \pi,
\end{equation}
%
or
\begin{equation}\label{eqn:modernOptics:problemSet3:3:400}
\sin\theta_l = \frac{l \lambda}{N a},
\end{equation}
%
For the distance between zeros past the center \(\theta = 0\) lobe for a fixed wavelength, we have
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:420}
\begin{aligned}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:440}
\begin{aligned}
\sin\theta_{l+1} - \sin\theta_l
&\sim
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:480}
\begin{aligned}
\Delta \theta
&=
...
%
but we also have
\begin{equation}\label{eqn:modernOptics:problemSet3:3:500}
\begin{aligned}
\Delta \theta
...
Comparing the two
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:520}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:560}
I \sim
\frac
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:580}
h_m = \pm \left( m - \inv{2} \right) a.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:600}
\Bk_m = k \frac{ L \zcap \pm h_m \ycap }{\sqrt{ L^2 + h_m^2} } \sim \frac{k h_m}{L} \ycap.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:620}
{\Br'}_m = \ycap h_m.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:640}
\rcap \cdot {\Br'}_m = \pm h_m \sin\theta.
\end{equation}
\begin{equation}\label{eqn:modernOptics:problemSet3:3:660}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:680}
\Psi
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:700}
...
or
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:720}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:740}
\begin{aligned}
I
&=
\Psi \Psi^\conj \\
...
\left(
   ...
   \right)
\right) \times \\
&\qquad (\cos (2 \gamma (m-n)) + \cos ( 2 \gamma (m+n-1))) \\
&=
\sum_{m,n = 1}^{M}
\cos\left(
   \frac{k a^2}{L}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:780}
\begin{aligned}
&\sum_{m, n = 1}^N f(m - n, m + n - 1) \\
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:820}
k a^2 M/L \sim \frac{\pi a \Delta \theta_s }{\lambda} \ll 1,
\end{equation}
%
leaving just
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:840}
I \sim
\left( \sum_{s = -M + 1}^{M - 1}
+
...
Using
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:860}
\sum_a^b e^{i \alpha m} = e^{i \alpha (b + a)/2} \frac{\sin(\alpha (b - a + 1)/2)}{\sin( \alpha/2)},
\end{equation}
%
the intensity sums to
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:880}
\begin{aligned}
I
&\sim
(1 + \cos( 2 \gamma M ) )
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:900}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:920}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:940}
\begin{aligned}
2 \gamma M
&\sim 2 \frac{2 \pi}{\lambda} \frac{a \sin\theta}{2} \frac{L \Delta \theta_s}{2 a} \\
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:980}
...
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:1000}
a N_{\mathrm{eff}} = l_{\mathrm{tc}} \Delta \theta_s.
\end{equation}
%
The angular spread of a single slit is
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:1020}
...
so we have
%
\begin{equation}\label{eqn:modernOptics:problemSet3:3:1040}
\begin{aligned}
\Delta \lambda
