...
\makeproblem{Even function Fourier transform.}{pr:cosineTransforms:2}{ 
Express the Fourier transform of an even function in terms of cosines.
} % makeproblem
\makeanswer{pr:cosineTransforms:2}{
%
\begin{equation}\label{eqn:cosineTransforms:50}
\begin{aligned}
\int_{-\infty}^\infty e^{-i\omega \tau} f(\tau) d\tau
&= \int_{-\infty}^0 e^{-i\omega \tau} f(\tau) d\tau +\int_{0}^\infty e^{-i\omega \tau} f(\tau) d\tau \\
&= \int_{-\infty}^0 e^{-i\omega \tau} f(-\tau) d\tau +\int_{0}^\infty e^{-i\omega \tau} f(\tau) d\tau \\
&= -\int_{\infty}^0 e^{i\omega \tau} f(\tau) d\tau +\int_{0}^\infty e^{-i\omega \tau} f(\tau) d\tau \\
&= \int_0^{\infty} e^{i\omega \tau} f(\tau) d\tau +\int_{0}^\infty e^{-i\omega \tau} f(\tau) d\tau \\
&= \int_0^{\infty} \left( e^{i\omega \tau} +e^{-i\omega \tau} \right) f(\tau) d\tau \\
&= 2 \int_0^{\infty} \cos( \omega \tau ) f(\tau) d\tau.
\end{aligned}
\end{equation}
%
Let's write
...
with
%
\begin{equation}\label{eqn:cosineTransforms:90}
\tilde{f}(\omega) =
\int_{-\infty}^{\infty}
e^{-i \omega \tau }
f(\tau) d\tau.
...
\makeproblem{Inverse transform, even function.}{pr:cosineTransforms:3}{ } % makeproblem
\makeanswer{pr:cosineTransforms:3}{
%
\begin{equation}\label{eqn:cosineTransforms:130}
\begin{aligned}
f(\tau)
&=
...
with
%
\begin{equation}\label{eqn:cosineTransforms:170}
(f \conj g)(\tau)
...
%
\begin{equation}\label{eqn:cosineTransforms:190}
\begin{aligned}
(f \conj g)(-\tau)
...
\makeproblem{Cosine transform, even functions.}{pr:cosineTransforms:5}{
What is the cosine transformation of a convolution of even functions.
} % makeproblem
\makeanswer{pr:cosineTransforms:5}{
It's not obvious that we can even do this.  If we start naively
%
\begin{equation}\label{eqn:cosineTransforms:210}
\begin{aligned}
...
%
\begin{equation}\label{eqn:cosineTransforms:230}
\begin{aligned}
\int_0^\infty &d\tau \cos(\omega \tau) \int_{-\infty}^\infty f(\tau') g(\tau' - \tau) d\tau' \\
&=
