...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem1Fig1}{Geometry for the masked diffraction problems.}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig1}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:10}
M
= M_2 M_1
=
\begin{bmatrix}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem1Fig2}{Diffraction geometry with lens.}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig2}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:130}
\begin{aligned}
k R
&= k \sqrt{ (\Br - \Br')^2 } \\
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem1Fig3}{Single rectangular slit.}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig3}{0.2}
%
Let's write \(\mu = -i k \alpha\) and \(\nu = -i k \beta\) so that we want to compute
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:210}
\begin{aligned}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem1Fig4}{Three slit diffraction aperture.}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig4}{0.2}
%
We form the integral
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:290}
\begin{aligned}
...
we have
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:330}
\sum_{n=-1}^{n=1}
e^{-i k \alpha n b}
=
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem1Fig5}{Gaussian transmission function aperture.}{fig:modernOpticsProblemSet2Problem1:modernOpticsProblemSet2Problem1Fig5}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:490}
\int dx' e^{-{x'}^2/\sigma_x^2 -i k x' \alpha}
=
...
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P1:510}
\begin{aligned}
\int dx' e^{-{x'}^2/\sigma_x^2 -i k x' \alpha}
&=
