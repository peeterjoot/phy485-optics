...
%\imageFigure{../figures/phy485-optics/modernOpticsMidtermReflectionFig1}{Lloyd's mirror.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig1}{0.2}
\imageFigure{../figures/phy485-optics/\subfigdir/modernOpticsMidtermReflectionFig1}{Lloyd's mirror.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig1}{0.2}
} % makeproblem
%
...
\begin{equation}\label{eqn:modernOpticsMidtermReflection:60}
b - d
=
L
\left(
...
%
or
\begin{equation}\label{eqn:modernOpticsMidtermReflection:60b}
b - d
= \frac{2 h}{L}( h + x ).
\end{equation}
%
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:80}
\Psi_d = \frac{\Psi_0}{d} e^{i k d - i \omega t + \phi_d(t)}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:100}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:120}
\begin{aligned}
I(\tau)
&= \expectation{
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:140}
\gamma(y, \tau) \sim
\cos \left(
\frac{2 k h}{L} y
- \omega \tau
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:160}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:560}
...
\begin{equation}\label{eqn:modernOpticsMidtermReflection:540}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:180}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:200}
\begin{aligned}
\Psi
&=
\frac{1}{\sqrt{2 \pi} r_1} \int d\omega \tilde{\Psi}_0(\omega) e^{i \omega \left( r_1/c - t \right) + i \phi_1(t)} \\
&\quad+\frac{1}{\sqrt{2 \pi} r_2} \int d\omega \tilde{\Psi}_0(\omega) e^{i \omega \left( r_2/c - t - \tau \right) + i\phi_2(t + \tau)},
\end{aligned}
\end{equation}
...
\end{equation}
Let
\begin{equation}\label{eqn:modernOpticsMidtermReflection:240}
\Psi_0(t) =
\frac{1}{\sqrt{2 \pi}} \int d\omega \tilde{\Psi}_0(\omega) e^{-i \omega  t},
\end{equation}
so that the interference term is
\begin{equation}\label{eqn:modernOpticsMidtermReflection:260}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:280}
...
\begin{equation}\label{eqn:modernOpticsMidtermReflection:300}
\begin{aligned}
\Gamma(\tau)
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:320}
\Psi_0(u) = 0.
\end{equation}
%
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:360}
\tilde{\Psi_0}(\omega) =
\frac{1}{\sqrt{2 \pi}} \int dt \Psi_0(t) e^{i \omega  t}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:380}
\Psi_0(t) =
\frac{1}{\sqrt{2 \pi}} \int d\omega \tilde{\Psi}_0(\omega) e^{-i \omega  t}.
\end{equation}
\end{subequations}
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:340}
\begin{aligned}
\Gamma(\tau)
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:440}
\Gamma(\tau)
\sim
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:400}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:420}
\begin{aligned}
\Psi(r, t) 
&= \inv{(\sqrt{ 2 \pi })^2 r \Delta \omega }
\int d\omega
\exp\left(
-\frac{(\omega - \omega_0)^2}
{2 (\Delta \omega)^2}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:460}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:480}
\frac{r_1 - r_2}{c} = \frac{2 h}{L c}( h + x ),
\end{equation}
%
so our mutual correlation is
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:500}
\begin{aligned}
&\Gamma(\tau) \\
&\sim
\exp
...
\imageFigure{../figures/phy485-optics/modernOpticsMidtermReflectionFig2}{Lloyd's mirror configuration for a distributed source.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig2}{0.2}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:680}
\begin{aligned}
\Psi
&=
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:760}
\begin{aligned}
\Psi(y)
=
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:780}
\begin{aligned}
\Psi(y) 
&\sim
e^{i k L}
...
We write
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1000}
\BR + \Br' = \Br.
\end{equation}
%
or
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1020}
\BR = \Br - \Br'.
\end{equation}
%
with scalar magnitude
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:800}
\begin{aligned}
R
&= r \left( 1 + \frac{{r'}^2}{r^2} - \frac{2}{r^2} \Br \cdot \Br' \right)^{1/2} \\
&\sim r + \frac{{r'}^2}{2 r} - \frac{1}{r} \Br \cdot \Br' \\
&\sim r - \frac{1}{f} (0, f \theta, f) \cdot (0, y', 0) \\
&= r - \theta y'.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:820}
\begin{aligned}
\Psi(0, \theta f, f)
&\sim \Psi_s \frac{e^{i k f}}{f} \int_A e^{-i k \theta y'} dy' \\
...
For \(A_{+}\) we have
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:840}
\begin{aligned}
\int e^{-i k_y y'} dy'
&= \evalrange{\frac{e^{-i k_y y'}}{-i k_y}}{h - \Delta y/2}{h + \Delta y/2} \\
&= \inv{i k_y} \lr{ -e^{-i k_y( h + \Delta y/2 ) } + e^{-i k_y( h - \Delta y/2 ) } } \\
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:860}
\Psi = 2 \Psi_s \frac{e^{i k f}}{f} \cos ( k_y h ) \frac{\sin( k_y \Delta y/2 )}{k_y /2}.
\end{equation}
%
Compare this to our point source treatment, which is
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:880}
\Psi
=
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:900}
I_{\text{point source}} \sim \cos^2( k_y h ).
\end{equation}
\begin{equation}\label{eqn:modernOpticsMidtermReflection:920}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:940}
\sin^2 \left( k_y \Delta y / 2 \right) = \inv{2}.
\end{equation}
%
or
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:960}
k_y \frac{\Delta y}{2} = \frac{\pi}{4}.
\end{equation}
%
or
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:980}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsMidtermReflectionFig6}{Spatial interferometry with Lloyd's mirror.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig6}{0.2}
%
...
%
%\begin{equation}\label{eqn:modernOpticsMidtermReflection:1360}
%I
%=
%\Abs{\Psi_1 + \Psi_2}^2
%=
...
%
%\begin{equation}\label{eqn:modernOpticsMidtermReflection:1380}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsMidtermReflectionFig7}{Coordinates for Lloyd's mirror spatially distributed interferometry problem.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig7}{0.2}
%
We have
%
\begin{subequations}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1440}
\frac{h + y}{\sqrt{h^2 + L^2}} \approx \frac{h + y}{L} = \tan\theta \sim \theta.
\end{equation}
%
\imageFigure{../figures/phy485-optics/modernOpticsMidtermReflectionFig9}{Angle from mirror to observation point.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig9}{0.2}
%
So that our plug into \eqnref{eqn:modernOpticsMidtermReflection:1340} takes the form
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1460}
\begin{aligned}
\Gamma_{12}
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1480}
\gamma_{12} = \sinc(k \theta \Delta w).
\end{equation}
%
We are interested in the visibility
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1500}
\calV = \Abs{\gamma_{12}},
\end{equation}
%
as plotted in \cref{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig8} for \(x = k \theta \Delta w\).
%
\imageFigure{../figures/phy485-optics/modernOpticsMidtermReflectionFig8}{Visibility curve for Lloyd's mirror and spatially distributed source.}{fig:modernOpticsMidtermReflection:modernOpticsMidtermReflectionFig8}{0.2}
%
At what point on that first lobe does the visibility drop to \(1/2\)?  With small enough \(x\), where \(x \ll \pi/2\) we have
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1520}
\Abs{\sinc(x)} \approx
...
%
\begin{equation}\label{eqn:modernOpticsMidtermReflection:1540}
1 - \inv{6} \left(
k \theta \Delta w
\right)
= \inv{2},
