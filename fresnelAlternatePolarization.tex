...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:390}
\BE_p = \Be_2 E_p.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:410}
...
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:430}
E_i + E_r
...
\begin{equation}\label{eqn:fresnelAlternatePolarization:450}
E_i + E_r = E_t.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:470}
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:490}
2 E_i = \left( 1 + \frac{\mu_1 v_1}{\mu_2 v_2} \frac{\cos{ \theta_t}}{\cos\theta_i} \right) E_t.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:510}
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:530}
\frac{E_t}{E_i}
=
...
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:550}
\frac{E_r}{E_i}
=
\frac
{
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:570}
-\mcap_p \rightarrow -\mcap_p \Be_2 \mcap_p = \Be_2.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:590}
...
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:730}
...
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:930}
\begin{aligned}
\Be_{32} e^{\mcap_q \Be_2 \phi_q}
&= \Be_{32} \cos \phi_q +\Be_{32} \mcap_q \Be_2 \sin{\phi_q} \\
&= \Be_{32} \cos \phi_q +\Be_{32} \Be_3 j e^{j \theta_q} \Be_2 \sin{\phi_q} \\
&= \Be_{32} \cos \phi_q -j e^{j \theta_q} \sin{\phi_q} \\
&= \Be_{32} \cos \phi_q - \Be_{31} \cos\theta_q \sin\phi_q + \sin\theta_q \sin{\phi_q}.
\end{aligned}
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:930b}
\begin{aligned}
\Be_{32} e^{\mcap_r \Be_2 \phi_r}
&= \Be_{32} \cos \phi_r +\Be_{32} \mcap_r \Be_2 \sin{\phi_r} \\
&= \Be_{32} \cos \phi_r +\Be_{32} (-\Be_3) j e^{-j \theta_r} \Be_2 \sin{\phi_r} \\
&= \Be_{32} \cos \phi_r + j e^{-j \theta_r} \sin{\phi_r} \\
&= \Be_{32} \cos \phi_r + \Be_{31} \cos\theta_r \sin{\phi_r} + \sin \theta_r \sin{\phi_r}.
\end{aligned}
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:950}
\begin{aligned}
...
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:970}
\begin{aligned}
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:990}
\epsilon_1 \left(
E_i
...
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1010}
\inv{v_1}
\left(
E_i
...
\end{equation}
%\begin{equation}\label{eqn:fresnelAlternatePolarization:1030}
%E_i
%\left(
...
%\right)
%\end{equation}
%\begin{equation}\label{eqn:fresnelAlternatePolarization:1050}
%\inv{\mu_1 v_1}
%\left(
%E_i
%\left(
...
%\right)
%\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1030a}
E_i
\cos \phi_i
+
E_r
...
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:1030b}
-E_i
...
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1050a}
\inv{\mu_1 v_1}
\left(
E_i
...
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:1050b}
\inv{\mu_1 v_1}
\left(
E_i
\sin{\phi_i}
...
\begin{equation}\label{eqn:fresnelAlternatePolarization:1070}
E_i
\cos \phi_i
+
E_r
...
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:1090}
-E_i
\sin\phi_i
+
E_r
...
\sin\phi_t.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1110}
E_i
\cos \phi_i
-
E_r
...
\end{equation}
%
\begin{equation}\label{eqn:fresnelAlternatePolarization:1130}
E_i
\sin{\phi_i}
+
E_r
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1150}
\frac{E_{r \parallel}}{E_{i \parallel}} = \frac{1 - \alpha \beta}{1 + \alpha \beta}.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1170}
\frac{E_{t \parallel}}{E_{i \parallel}} = \frac{2 }{1 + \alpha \beta}.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1190}
\frac{E_{r \perp}}{E_{i \perp}} = \frac{ \beta - \alpha }{\beta + \alpha}.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1210}
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1230}
\BE_i = E_{i} \Be_2 e^{\Be_2 \mcap_i \phi}.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1250}
\BE_r =
E_{i \parallel}
...
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1270}
\BE_t =
E_{i \parallel}
\frac{2}{1 + \alpha\beta}
\Be_2
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1290}
\BE_i = E_{i} \left( \Be_2 \cos\phi + \Be_1 e^{j \theta_i} \sin\phi \right).
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1310}
\BE_r =
E_i
\left(
\cos\phi
...
\right).
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1330}
\BE_t =
E_i
\left(
\cos\phi
...
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1350}
\tan \phi_r = \tan \phi
\frac{\beta - \alpha}{\beta + \alpha}
\frac{1 + \alpha \beta}{1 - \alpha \beta}.
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1370}
...
%
\begin{subequations}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1310c}
\frac{E_r}{E_i}
=
\sqrt{
\left(\cos\phi
...
\end{equation}
\begin{equation}\label{eqn:fresnelAlternatePolarization:1330c}
\frac{E_t}{E_i}
=
\sqrt{
\left(
