...
\begin{equation}\label{eqn:modernOpticsLecture18:20}
\spacegrad \cross \BH = \epsilon \PD{t}{\BE}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:40}
\spacegrad \cross \BE = -\mu \PD{t}{\BH}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:80}
\spacegrad \cdot (\epsilon \BE) = 0.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:60}
\spacegrad \cdot \BB = 0.
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:840}
k x - \omega t
= k ( x - v t )
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:660}
\begin{aligned}
\spacegrad (\spacegrad \cdot \BE) - \spacegrad^2 \BE
&= -\spacegrad \cross \left( \mu \PD{t}{\BH} \right) \\
&= -( \spacegrad \mu ) \cross \PD{t}{\BH} -\mu \spacegrad \cross \PD{t}{\BH} \\
...
%
or
\begin{equation}\label{eqn:modernOpticsLecture18:680}
\begin{aligned}
 \spacegrad^2 \BE
 -\mu \epsilon
\PDSq{t}{\BE}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:700}
\begin{aligned}
\PDSq{t}{}\BE(\Br, t)
&= -\BE(\Br) \omega^2 e^{-i \omega t} \\
&= -\BE(\Br) \frac{k^2}{\epsilon\mu} e^{-i \omega t} \\
&= -\BE(\Br) k^2 e^{-i \omega t}.
\end{aligned}
\end{equation}
%
Provided we have
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig1}{Possible \(\epsilon\) dependence in medium.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig1}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:360}
\begin{aligned}
\PDSq{z}{} u e^{i k_0 z}
&=
\PD{z}{}
...
If
%
\begin{equation}\label{eqn:modernOpticsLecture18:420}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:460}
\spacegrad_{\txtT}^2 =
\PDSq{x}{}
+\PDSq{y}{}.
\end{equation}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:500}
...
%
or
\begin{equation}\label{eqn:modernOpticsLecture18:860}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture18:740}
\frac{m^2 \omega^2}{\Hbar^2} \leftrightarrow k_0 k_2.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:760}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig2}{Radiation and matter wave equivalence.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig2}{0.15}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig3u0}{First order 1D SHO matter wave.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u0}{0.2}
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig3u1}{Second order 1D SHO matter wave.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u1}{0.2}
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig3u2}{Third order 1D SHO matter wave.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3u2}{0.2}
%
%Recall that our 1D SHO solutions look like
%\cref{fig:modernOpticsLecture18:modernOpticsLecture18Fig3}.
%\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig3}{First couple SHO solutions.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig3}{0.2}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig4}{2D SHO solutions.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig4}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:560}
z \rightarrow
%\mathLabelBox{
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1380}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1400}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:580}
m_{\mathrm{eff}} = \frac{\Hbar \omega}{c^2}.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture18:600}
m_{\mathrm{eff}} c^2 = \Hbar \omega.
\end{equation}
%
This is a dispersion relation \cref{fig:modernOpticsLecture18:modernOpticsLecture18Fig5}.
%
\begin{equation}\label{eqn:modernOpticsLecture18:620}
\begin{aligned}
E
&= \Hbar \omega \\
...
\end{equation}
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture18Fig5}{Dispersive electric field.}{fig:modernOpticsLecture18:modernOpticsLecture18Fig5}{0.2}
%
%\fxwarning{also not clear what is being illustrated here}
%
\begin{equation}\label{eqn:modernOpticsLecture18:640}
k_z \gg k_x, k_y.
\end{equation}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:880}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture18:900}
\PD{p}{H} = \xdot = \frac{p}{m}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:920}
\PD{x}{H} = -\pdot = m \omega^2 x.
\end{equation}
\end{subequations}
%
That is
\begin{equation}\label{eqn:modernOpticsLecture18:940}
\left( m \xdot \right)' = - m \omega^2 x,
\end{equation}
%
or
\begin{equation}\label{eqn:modernOpticsLecture18:960}
\ddot{x} = - \omega^2 x,
\end{equation}
%
with solutions
%
\begin{equation}\label{eqn:modernOpticsLecture18:980}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1000}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1040}
\inv{U} \left(
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture18:1280}
\tau = \frac{\omega}{c} (c t).
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:1080}
\epsilon = \frac{E}{\Hbar \omega}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:1300}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1140a}
0 =
\left(
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1120}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture18:1160}
\dimensions{\sqrt{k_0 k_2}} = \inv{\txtL^2}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:1180}
...
and introduce
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture18:1320}
\tau = \sqrt{\frac{k_2}{k_0}} z.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:1340}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1140b}
0 =
\left(
\PDSq{\xi}{} + \inv{\xi} \PD{\xi}{} +
\left( 2 \epsilon - \xi^2 \right)
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture18:1220}
\frac{\omega_{\mathrm{eff}}}{c} \equiv \sqrt{\frac{k_2}{k_0}}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:1240a}
m_{\mathrm{eff}} \equiv \frac{\Hbar k_0}{c},
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture18:1240b}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1260}
...
%
\begin{equation}\label{eqn:modernOpticsLecture18:1360}
