...
\imageFigure{../figures/phy485-optics/normalReflectionPolarizationFig1}{Normal incidence coordinates.}{fig:normalReflectionPolarization:normalReflectionPolarizationFig1}{0.2}
\begin{subequations}
...
We see that there is only one solution for the polarization angle of the transmitted and reflected waves relative to the incident wave.  Although we fixed the incident polarization with \(\BE\) along \(\xcap\), the polarization of the incident wave is maintained regardless of TE or TM labelling in this example, since our system is symmetric with respect to rotation.
