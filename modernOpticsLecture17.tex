...
%
\begin{equation}\label{eqn:modernOpticsLecture17:20}
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture17Fig1}{Cavity.}{fig:modernOpticsLecture17:modernOpticsLecture17Fig1}{0.2}
%
\begin{equation}\label{eqn:modernOpticsLecture17:60}
...
We typically have
%
\begin{equation}\label{eqn:modernOpticsLecture17:80}
\Gamma_{\mathrm{sp}} = 10^{7} \txts^{-1}.
\end{equation}
%
The spontaneous em rate out of cavity, and
%
\begin{equation}\label{eqn:modernOpticsLecture17:100}
...
Recall
%
\begin{equation}\label{eqn:modernOpticsLecture17:120}
...
%
\begin{equation}\label{eqn:modernOpticsLecture17:140}
\ddt{N_2} = N R - N_2 \Gamma_{\mathrm{sp}} - N_2 \Gamma_{\mathrm{st}} \expectation{ n }.
\end{equation}
%
and the photon population is
%
\begin{equation}\label{eqn:modernOpticsLecture17:160}
\ddt{\expectation{n}} =
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture17Fig2}{Probability distribution.}{fig:modernOpticsLecture17:modernOpticsLecture17Fig2}{0.2}
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture17:300}
\expectation{n} = \sum_n n P_n.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture17:320}
...
%
\begin{equation}\label{eqn:modernOpticsLecture17:180}
N_2 = \frac{N R}{ \Gamma_{\mathrm{sp}} + \Gamma_{\mathrm{st}} \expectation{n} }.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture17:200}
...
%
\begin{equation}\label{eqn:modernOpticsLecture17:380}
0
= \Gamma_{\mathrm{st}}
\frac{N R}{ \Gamma_{\mathrm{sp}} + \Gamma_{\mathrm{st}} \expectation{n} }
...
or
%
\begin{equation}\label{eqn:modernOpticsLecture17:400}
\begin{aligned}
0
&=
...
%
\begin{equation}\label{eqn:modernOpticsLecture17:220}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture17:240}
\expectation{n}^2 - (C - 1) n_s \expectation{n} - C n_s = 0.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture17:260}
C \equiv
\frac{ N R \Gamma_{\mathrm{st}} }{\Gamma_{\mathrm{sp}} \Gamma_{\mathrm{cav}} }.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture17:280}
...
%
\begin{equation}\label{eqn:modernOpticsLecture17:340}
\begin{aligned}
\expectation{n}
...
%
\begin{equation}\label{eqn:modernOpticsLecture17:360}
