...
%
\begin{equation}\label{eqn:poyntingComplex:90b}
\expectation{ \BS } =
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:1270}
\begin{aligned}
\BE_0 \cross \BB_0^\conj
&= \BE_0 \cross \lr{ \inv{k_0} \spacegrad \phi \cross \BE_0  }^\conj \\
&= \inv{k_0} \BE_0 \cross \lr{ \spacegrad \phi \cross \BE_0^\conj } \\
&= -\inv{k_0} \lr{ (\cancel{\BE_0 \cdot \spacegrad \phi}) \BE_0^\conj - \Abs{\BE_0}^2 \spacegrad \phi } \\
...
\begin{equation}\label{eqn:modernOpticsLecture2:1370}
\begin{aligned}
\left(\spacegrad \phi \cdot \spacegrad \right) \spacegrad \phi
&= \lr{ \partial_k \phi \partial_k } \Be_m \partial_m \phi \\
&= \Be_m \partial_k \phi \partial_m \partial_k \phi \\
&= \inv{2} \Be_m \partial_m \lr{ \partial_k \phi \partial_k \phi } \\
&= \inv{2} \spacegrad \lr{ \spacegrad \phi }^2.
\end{aligned}
\end{equation}
%
Now we use Eikonal \eqnref{eqn:modernOpticsLecture2:230}
%
\begin{equation}\label{eqn:modernOpticsLecture2:1390}
\begin{aligned}
\left(\spacegrad \phi \cdot \spacegrad \right) \spacegrad \phi
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:1290}
\spacegrad n = \left(
\rcap \PD{r}{}
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:1310}
\int \frac{dn}{n} = - \int \frac{dr}{R},
\end{equation}
%
or
%
\begin{equation}\label{eqn:modernOpticsLecture2:1330}
\ln n = -r + \ln n(0).
\end{equation}
%
Exponentiating we have
%
\begin{equation}\label{eqn:modernOpticsLecture2:1350}
n = n(0) e^{-r}.
\end{equation}
} % makeanswer
...
\makeproblem{Eikonal equation, Geometric Algebra.}{modernOpticsLecture2:pr4}{ Express \eqnref{eqn:modernOpticsLecture2:140} in it's Geometric Algebra form, and figure out how \eqnref{eqn:modernOpticsLecture2:230} follows from that directly.
}
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:870}
...
\begin{equation}\label{eqn:modernOpticsLecture2:890}
\spacegrad \BE = -\frac{I}{c} \PD{t}{\BB}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture2:910}
...
\begin{equation}\label{eqn:modernOpticsLecture2:890b}
\spacegrad \BE = -\frac{\sqrt{\mu\epsilon}}{c} \PD{t}{} \frac{I \BB}{\sqrt{\mu\epsilon}}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture2:910b}
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:1010}
\begin{aligned}
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:1130a}
\kcap(\Br) = \frac{\spacegrad \phi}{k_0 n}.
\end{equation}
%
Using that, the equation to solve takes the form
%
\begin{equation}\label{eqn:modernOpticsLecture2:1030b}
\kcap F_0 = F_0.
\end{equation}
%
Let's check that this matches our expectations by multiplying out this equation explicitly
%
\begin{equation}\label{eqn:modernOpticsLecture2:1170}
\begin{aligned}
\BE + \frac{I}{n} \BB
&= \kcap \left(\BE + \frac{I}{n} \BB\right) \\
&=
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture2:1190}
\kcap \cdot \BE_0 = 0.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture2:1210}
\kcap \cdot \BB_0 = 0.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture2:1230}
\BE_0 = -\kcap \cross \frac{\BB_0}{n}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture2:1250}
...
Application of Maxwell's equation \eqnref{eqn:modernOpticsLecture2:930} to this we find
%
\begin{equation}\label{eqn:modernOpticsLecture2:1010b}
\begin{aligned}
&\left( \spacegrad + \frac{\sqrt{\mu \epsilon}}{c} \PD{t}{} \right) F_0
e^{i \phi - i\omega t} \\
&=
...
Neglecting the \(\spacegrad F_0\) term, writing \(\omega/c = k_0\) and requiring this to hold for any phase we have
%
\begin{equation}\label{eqn:modernOpticsLecture2:1030c}
(\spacegrad \phi) F_0 = k_0 n(\Br) F_0.
\end{equation}
%
Left multiplication by \(\spacegrad \phi\) gives us
%
\begin{equation}\label{eqn:modernOpticsLecture2:1090b}
(\spacegrad \phi)^2 F_0 = k_0 n (\spacegrad \phi) F_0 = k_0^2 n^2 F_0,
\end{equation}
%
yielding the Eikonal equation as desired
%
\begin{equation}\label{eqn:modernOpticsLecture2:1110b}
(\spacegrad \phi)^2 = k_0^2 n^2.
\end{equation}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture2:1150a}
F_0 = (1 + \kcap) \BC.
\end{equation}
%
