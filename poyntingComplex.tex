...
\begin{equation}\label{eqn:poyntingComplex:10}
\tilde{\BE} = \BE_0 e^{i (\Bk \cdot \Bx - \omega t)}.
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:30}
...
%
\begin{equation}\label{eqn:poyntingComplex:50}
\BE = \Real( \tilde{\BE} ).
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:70}
\BH = \Real( \tilde{\BH} ).
\end{equation}
%
Show that the average Poynting vector has the value
%
\begin{equation}\label{eqn:poyntingComplex:90}
...
%
\begin{equation}\label{eqn:poyntingComplex:110}
\BE_0 = \sum_k (\BE_{kr} + i \BE_{ki}) \Be_k = \sum_k \Abs{\BE_k} e^{i \phi_k} \Be_k.
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:130}
...
%
\begin{equation}\label{eqn:poyntingComplex:210}
\begin{aligned}
\expectation{ \cos(a - \omega t) \cos(b - \omega t) }
&= \inv{T} \int_0^T \cos(a - \omega t) \cos(b - \omega t) dt \\
&= \inv{\omega T} \int_0^T \cos(a - \omega t) \cos(b - \omega t) \omega dt \\
&= \inv{2 \pi} \int_0^{2 \pi} \cos(a - u) \cos(b - u) du \\
&= \inv{4 \pi} \int_0^{2 \pi} \cos(a + b - 2 u) + \cos(a - b) du \\
&= \inv{2} \cos(a - b).
\end{aligned}
\end{equation}
%
So, our average Poynting vector is
\begin{equation}\label{eqn:poyntingComplex:230}
...
%
\begin{equation}\label{eqn:poyntingComplex:250}
\begin{aligned}
...
%
\begin{equation}\label{eqn:poyntingComplex:370}
\begin{bmatrix}
A \\
B e^{i\Delta}
\end{bmatrix}.
...
%
\begin{equation}\label{eqn:poyntingComplex:390}
...
%
\begin{equation}\label{eqn:poyntingComplex:410}
\begin{bmatrix}
x' \\
y'
\end{bmatrix}
...
%
\begin{equation}\label{eqn:poyntingComplex:430}
...
%
\begin{equation}\label{eqn:poyntingComplex:450}
\begin{bmatrix}
\xcap' \\
\ycap'
\end{bmatrix}
...
%
\begin{equation}\label{eqn:poyntingComplex:470}
\begin{bmatrix}
x' \\
y'
\end{bmatrix}
...
\begin{equation}\label{eqn:poyntingComplex:490}
\begin{bmatrix}
\cos \theta & \sin\theta \\
-\sin\theta & \cos\theta
\end{bmatrix}
...
or
%
\begin{equation}\label{eqn:poyntingComplex:510}
\begin{bmatrix}
x \\
y
\end{bmatrix}
...
Observing that
%
\begin{equation}\label{eqn:poyntingComplex:530}
...
%
\begin{equation}\label{eqn:poyntingComplex:550}
\begin{aligned}
\begin{bmatrix}
x \\
y
...
%
\begin{equation}\label{eqn:poyntingComplex:570}
\begin{aligned}
&\begin{bmatrix}
x \\
y
...
%
\begin{equation}\label{eqn:poyntingComplex:590}
A = \sqrt{ a^2 \cos^2 \theta + b^2 \sin^2 \theta }.
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:610}
B = \sqrt{ a^2 \sin^2 \theta + b^2 \cos^2 \theta }.
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:630}
\Delta =
...
%
\begin{equation}\label{eqn:poyntingComplex:650}
\BE =
\Real\left(
\begin{bmatrix}
A \\
...
%
\begin{equation}\label{eqn:poyntingComplex:670}
\begin{aligned}
\cos( a + b ) 
&= \Real \left(
(\cos a + i \sin a)
...
%
\begin{equation}\label{eqn:poyntingComplex:690}
x = A \cos u.
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:710}
y = B ( \cos \Delta \cos u + \sin \Delta \sin u ).
\end{equation}
%
Subtracting \(x \cos \Delta/A\) from \(y/B\) we have
%
\begin{equation}\label{eqn:poyntingComplex:730}
...
%
\begin{equation}\label{eqn:poyntingComplex:470b}
\begin{bmatrix}
x \\
y
\end{bmatrix}
...
we have
%
\begin{equation}\label{eqn:poyntingComplex:790}
\begin{aligned}
\sin^2 \Delta 
&=
...
&\quad +(y')^2 ( a^2 \sin^2 \theta + b^2 \cos^2 \theta + 2 a b \cos \theta \sin \theta \cos \Delta ) \\
&\quad + 2 x' y' ( (b^2 -a^2) \cos \theta \sin\theta + a b (\sin^2 \theta - \cos^2 \theta) \cos \Delta ).
\end{aligned}
\end{equation}
%
To kill off the cross term we require
\begin{equation}\label{eqn:poyntingComplex:810}
\begin{aligned}
0
...
%
or
\begin{equation}\label{eqn:poyntingComplex:830}
...
%
\begin{equation}\label{eqn:poyntingComplex:850}
\sin\Delta/
\sqrt{ b^2 + (a^2 - b^2) \cos^2 \theta - a b \sin (2 \theta) \cos \Delta }.
\end{equation}
\begin{equation}\label{eqn:poyntingComplex:870}
\sin\Delta/
