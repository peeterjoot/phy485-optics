...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet1Fig1aTake2}{Input and output conjugate planes for paraxial thin lens.}{fig:modernOpticsProblemSet1:modernOpticsProblemSet1Fig1aTake2}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1790}
\begin{aligned}
M
&= M_3 M_2 M_1 \\
&=
...
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1810}
\begin{bmatrix}
0 \\
\alpha
\end{bmatrix}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet1Fig2b1}{Newton's form, an image with magnification.}{fig:modernOpticsProblemSet1:modernOpticsProblemSet1Fig2b1}{0.2}
%
Compounding the transfer matrices we have
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1510}
\begin{aligned}
M
&= M_3 M_2 M_1 \\
&=
...
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet1Fig1c}{Position distribution at the focus of a lens.}{fig:modernOpticsProblemSet1:modernOpticsProblemSet1Fig1c}{0.2}
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1610}
\begin{aligned}
M
&= M_3 M_2 M_1 \\
&=
...
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1630}
\begin{bmatrix}
y \\
\theta
\end{bmatrix}
...
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1670}
\begin{aligned}
M
&= M_5 M_4 M_3 M_2 M_1 \\
&=
...
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1690}
\begin{bmatrix}
y \\
0
\end{bmatrix}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet1Fig1f}{Cat's eye.  Lens with mirror behind at focus.}{fig:modernOpticsProblemSet1:modernOpticsProblemSet1Fig1f}{0.2}
%
Our system transfer matrix is
%
\begin{equation}\label{eqn:modernOpticsProblemSet1P1:1730}
\begin{aligned}
M 
&=
M_7
