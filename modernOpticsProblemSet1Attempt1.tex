...
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet1Fig1a}{Thin paraxial lens with image in input and output conjugate planes.}{fig:modernOpticsProblemSet1Attempt1:modernOpticsProblemSet1Attempt1Fig1a}{0.2}
...
%
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1030}
%M =
%\begin{bmatrix}
%1 & 0 \\
%-1/f & 1
...
%
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1050}
%\begin{bmatrix}
%a \\
%-\beta
%\end{bmatrix}
...
%
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1070}
%-\beta = -\frac{a}{f} + 0,
%\end{equation}
%
%or
%
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1090}
%\beta = \frac{a}{f}.
%\end{equation}
%
%Similarly, when the output is horizontal at the point \((0, -b)\) we have
%
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1110}
%\begin{bmatrix}
%-b \\
%0
%\end{bmatrix}
...
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1130}
%0 = \frac{b}{f} - \theta
%\end{equation}
%
%or
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1150}
%\theta = \frac{b}{f}.
%\end{equation}
%
...
%
%\begin{subequations}
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1170}
%\tan \beta = \frac{a}{f}
%\end{equation}
%\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1190}
%\tan \theta = \frac{b}{f}.
%\end{equation}
%\end{subequations}
%
...
\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1250}
\frac{b}{a} = \frac{f}{x}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1270}
\frac{b}{a} = \frac{x'}{f}.
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1450}
0
= -\inv{f} + \inv{s} + \inv{s'}
= -\inv{f} + \inv{x + f} + \inv{x' + f}.
\end{equation}
%
Multiplying through by \(f(x + f)(x' + f)\) we have
%
\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1470}
\begin{aligned}
0
&= -(x + f)(x' + f) + f(x' + f) + f(x + f) \\
...
or
%
\begin{equation}\label{eqn:modernOpticsProblemSet1Attempt1:1490}
x x' = f^2.
\end{equation}
} % makeanswer
