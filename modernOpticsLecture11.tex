...
%
\begin{equation}\label{eqn:modernOpticsLecture11:10}
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:30}
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:50}
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:130}
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:150}
\tau_a - \tau_b \rightarrow 0,
\end{equation}
and
\begin{equation}\label{eqn:modernOpticsLecture11:170}
...
When
%
\begin{equation}\label{eqn:modernOpticsLecture11:190}
\Delta \tau = \frac{\lambda}{2 c}.
\end{equation}
%
when
%
\begin{equation}\label{eqn:modernOpticsLecture11:210}
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:230}
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:250}
\Bk_{\mathrm{av}} \cdot \Delta \Br,
\end{equation}
%
and a shift
%
\begin{equation}\label{eqn:modernOpticsLecture11:270}
k \frac{\Br_s \cdot \Delta \Br}{r_{\mathrm{av}}}.
\end{equation}
%
%\section{What's so special about this pathlength difference?}
\section{What's special about the pathlength difference?}
\index{pathlength difference}
%
\begin{equation}\label{eqn:modernOpticsLecture11:290}
\Delta \tau = \tau_a - \tau_b = \frac{\lambda}{2c}.
\end{equation}
%
Let's consider the fringes that we make, using an interferometer such as Lloyd's mirror, from source \(a\) made from these two points \cref{fig:modernOpticsLecture11:modernOpticsLecture11Fig5}.
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture11:310}
\begin{aligned}
I_{\mathrm{total}} 
&= \sum_{\Bk}
\Abs{
...
Here
%
\begin{equation}\label{eqn:modernOpticsLecture11:330}
