...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture4Fig1}{Laser on screen.}{fig:modernOpticsLecture4:modernOpticsLecture4Fig1}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture4Fig2}{Diffracting object (i.e. aperture).}{fig:modernOpticsLecture4:modernOpticsLecture4Fig2}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:10}
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:30}
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:50}
...
\begin{equation}\label{eqn:modernOpticsLecture4:90}
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:110}
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:130}
\spacegrad' = \Be_m \PD{{x'}_m}{}.
\end{equation}
%
If we take the gradient of the Green's function we find
%
\begin{equation}\label{eqn:modernOpticsLecture4:150}
\spacegrad \left(
\frac{ e^{i k r} }{r}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture4Fig4}{Neglecting the surface at infinity.}{fig:modernOpticsLecture4:modernOpticsLecture4Fig4}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture4Fig5}{Source, aperture and observation point.}{fig:modernOpticsLecture4:modernOpticsLecture4Fig5}{0.2}
%
Our spherical wave function at the aperture is
%
\begin{equation}\label{eqn:modernOpticsLecture4:190}
\Psi(\Br') = A \frac{e^{i k R_s}}{R_s}.
\end{equation}
%
so that
%
\begin{equation}\label{eqn:modernOpticsLecture4:210}
\begin{aligned}
\spacegrad' \Psi
&= - A \frac{\Br_s - \Br'}{\Abs{\Br_s - \Br'}} \left( i k - \inv{R_s} \right) \frac{e^{i k R_s}}{R_s} \\
&= - A \frac{\Br_s}{\Abs{\Br_s}} \left( i k - \inv{R_s} \right) \frac{e^{i k R_s}}{R_s} \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:230}
...
%
\begin{equation}\label{eqn:modernOpticsLecture4:250}
\spacegrad \left( \BE_0 e^{i\phi(\Br)} \right) \approx i (\BE_0 \cdot \spacegrad \phi ) e^{i \phi(\Br)},
\end{equation}
%
With an assumption
%
\begin{equation}\label{eqn:modernOpticsLecture4:270}
\lambda \ll r, r_s,
\end{equation}
%
and
%
\begin{equation}\label{eqn:modernOpticsLecture4:290}
\lambda \ll d \ll r, r_s,
\end{equation}
%
where \(d\) is the ``typical object size'', so that we have
%
\begin{equation}\label{eqn:modernOpticsLecture4:310}
...
where
%
\begin{equation}\label{eqn:modernOpticsLecture4:350}
...
%
%\begin{equation}\label{eqn:modernOpticsLecture4:370}
