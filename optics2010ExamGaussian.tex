...
%
\imageFigure{../figures/phy485-optics/optics2010ExamGaussianFig1}{Gaussian beam through glass then air.}{fig:optics2010ExamGaussian:optics2010ExamGaussianFig1}{0.2}
%
Going from the glass to the air we have \(n \sin\theta_i = \sin\theta_t\), or in the paraxial approximation
%
\begin{equation}\label{eqn:optics2010ExamGaussian:20}
\begin{bmatrix}
y_t \\
\theta_t
\end{bmatrix}
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:40}
\begin{aligned}
M &=
\begin{bmatrix}
1 & L/2 \\
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:60}
\begin{aligned}
q'
&= q + 2 D n \\
&= q + 2 (0.1) 1.5 \\
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:80}
\begin{aligned}
\inv{q + a}
&= \inv{z - i z_0 + a} \\
&= \frac{z + i z_0 + a} {(z + a)^2 + z_0^2 } \\
&=
\frac{z + a}
{(z + a)^2 + z_0^2 }
+ i \frac{z_0}
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:100}
\frac{\lambda_0}{\pi n w_0^2} = \frac{z_0}{z_0^2 } = \inv{z_0},
\end{equation}
%
or
%
\begin{equation}\label{eqn:optics2010ExamGaussian:120}
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:140}
...
Our new waist is
%
\begin{equation}\label{eqn:optics2010ExamGaussian:160}
{w_0'}^2
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:180}
\begin{aligned}
M'
&=
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:240}
\begin{aligned}
q''
&= \frac{ q' + L/2 }{n} \\
&= \frac{ q + 2 D n + L/2 }{n},
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:260}
\begin{aligned}
\inv{ q''(0) }
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:280}
\begin{aligned}
...
\end{equation}
%
\begin{equation}\label{eqn:optics2010ExamGaussian:200}
{w'}^2(0)
=
...
%
\begin{equation}\label{eqn:optics2010ExamGaussian:220}
\begin{aligned}
\Theta
