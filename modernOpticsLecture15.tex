...
Our geometry is
%
\begin{equation}\label{eqn:modernOpticsLecture15:640}
\BR + \Br' = \Br.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture15:740}
\BR_s + \Br' = \Br_s.
\end{equation}
%
for which our path length from \(\Br'\) to the observation point is
%
\begin{equation}\label{eqn:modernOpticsLecture15:660}
\Abs{\BR}
...
and to first order
%
\begin{equation}\label{eqn:modernOpticsLecture15:680}
k\Abs{\BR}
...
%
Similarly
\begin{equation}\label{eqn:modernOpticsLecture15:760}
\begin{aligned}
k\Abs{\BR_s}
...
With
%
\begin{equation}\label{eqn:modernOpticsLecture15:780}
k_y \equiv \frac{2 \pi}{\lambda} \sin\theta,
\end{equation}
%
and
\begin{equation}\label{eqn:modernOpticsLecture15:800}
k_{y,s} \equiv \frac{2 \pi}{\lambda} \sin\theta_s,
\end{equation}
%
our diffraction integral, in one dimension takes the form
%
\begin{equation}\label{eqn:modernOpticsLecture15:700}
\Psi(\Br) \sim \int e^{i (k_{y,s} - k_{y}) y' } dy'.
\end{equation}
%
or
\begin{equation}\label{eqn:modernOpticsLecture15:820}
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:720}
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:20}
f(y) = \int dy' g(y') h(y - y') = g(y) \conj h(y).
\end{equation}
%
Consider the convolution with the delta function comb
%
\begin{equation}\label{eqn:modernOpticsLecture15:40}
h(y) = \sum_{n=0}^{N-1} \delta (y - n a).
\end{equation}
%
So that the convolution is
%
\begin{equation}\label{eqn:modernOpticsLecture15:60}
\begin{aligned}
f(y)
&= \int dy' g(y') \sum_{n = 0}^{N-1} \delta(y - y' - n a) \\
&= \sum_{n = 0}^{N-1} \int dy' g(y') \delta(y - y' - n a) \\
&= \sum_{n = 0}^{N-1} g(y - n a).
\end{aligned}
\end{equation}
%
Convolution theorem
%
\begin{equation}\label{eqn:modernOpticsLecture15:80}
F( k_y ) = H( k_y ) G( k_y ).
\end{equation}
%
As mentioned, here we write
%
\begin{equation}\label{eqn:modernOpticsLecture15:100}
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:120}
\begin{aligned}
G(k_y)
&= \int_{-b/2}^{b/2} e^{-i k_y y} dy \\
&= \evalrange{\frac{e^{-i k_y y}}{-i k_y}}{-b/2}{b/2} \\
&= \frac{ e^{i k_y b/2} -e^{-i k_y b/2} } { 2 (i k_y) /2 } \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:140}
\begin{aligned}
H(k_y)
&= \int_{-\infty}^\infty e^{i k_y y} \sum_{n = 0}^{N-1} \delta(y - n a) \\
&= \sum_{n = 0}^{N-1} \int_{-\infty}^\infty e^{i k_y y} \delta(y - n a) \\
&= \sum_{n = 0}^{N-1} e^{i k_y n a} \\
&= \sum_{n = 0}^{N-1} \left( e^{i k_y a}  \right)^n.
\end{aligned}
\end{equation}
%
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture15:160}
a S_N = a + a^2 + \cdots a^{N}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture15:180}
S_N = 1 + a + \cdots a^{N-1}.
\end{equation}
\end{subequations}
%
so that
%
\begin{equation}\label{eqn:modernOpticsLecture15:200}
(a - 1)S_N = a^N - 1.
\end{equation}
%
or
\begin{equation}\label{eqn:modernOpticsLecture15:220}
S_N = \frac{a^N - 1}{a-1},
\end{equation}
%
and we have for our Fourier transform we have
%
\begin{equation}\label{eqn:modernOpticsLecture15:240}
\begin{aligned}
H(k_y)
...
We want
%
\begin{equation}\label{eqn:modernOpticsLecture15:280}
\begin{aligned}
I
&= \Abs{F(k_y)}^2 \\
&=
...
\paragraph{Check: \(N = 2\)}
%
\begin{equation}\label{eqn:modernOpticsLecture15:340}
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:360}
\gamma
...
where
%
\begin{equation}\label{eqn:modernOpticsLecture15:380}
\omega_0 = \frac{2 \pi c}{a},
\end{equation}
%
where \(a\) is the period of the diffraction grating.  The peak is at \(\gamma = m \pi\), or
%
\begin{equation}\label{eqn:modernOpticsLecture15:400}
\gamma_{\mathrm{peak}}
= m \pi
= \pi \frac{\omega}{\omega_0} \sin\theta,
\end{equation}
%
or
\begin{equation}\label{eqn:modernOpticsLecture15:420}
m = \frac{\omega}{\omega_0} \sin\theta,
\end{equation}
%
Zeros are at \(N \gamma = l \pi\) (provided \(l \ne N m\)).  Closest zero is
%
\begin{equation}\label{eqn:modernOpticsLecture15:440}
l = N m + 1.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture15:460}
\begin{aligned}
\Delta \gamma
...
or
%
\begin{equation}\label{eqn:modernOpticsLecture15:480}
\Delta \gamma
= \frac{\pi}{N}
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:500}
\gamma_{\mathrm{peak}, 1} = \pi \frac{\omega_1}{\omega_0} \sin\theta = m \pi.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture15:520}
\gamma_{\mathrm{peak}, 2} = \pi \frac{\omega_2}{\omega_0} \sin\theta = m \pi.
\end{equation}
%
so that
\begin{equation}\label{eqn:modernOpticsLecture15:540}
\Delta \gamma
=
\Delta \omega
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:560}
...
%
\begin{equation}\label{eqn:modernOpticsLecture15:600}
