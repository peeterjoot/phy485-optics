...
\imageFigure{../figures/phy485-optics/convexNonParaxialFig1}{Convex lens refraction.}{fig:convexNonParaxial:convexNonParaxialFig1}{0.2}
%
We have using the law of sines
\begin{equation}\label{eqn:convexNonParaxial:20}
\frac{\sin\theta_1}{R}
=
...
%
and also have
\begin{equation}\label{eqn:convexNonParaxial:40}
