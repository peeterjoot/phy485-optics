...
%
\begin{equation}\label{eqn:modernOpticsLecture6:110}
\begin{bmatrix}
x' \\
y'
\end{bmatrix}
...
Our integral is now
%
\begin{equation}\label{eqn:modernOpticsLecture6:150}
\begin{aligned}
\Psi(\Br)
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture6Fig3}{Region of integration.}{fig:modernOpticsLecture6:modernOpticsLecture6Fig3}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem2CornuSpiralPlainPlotFig4a}{Cornu Spiral.}{fig:modernOpticsLecture6:modernOpticsLecture6Fig4}{0.2}
% origin figure: (generated mathematica figure for ps2)
%\imageFigure{../figures/phy485-optics/modernOpticsLecture6Fig4}{Cornu spiral (rough illustration).}{fig:modernOpticsLecture6:modernOpticsLecture6Fig4}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture6:290}
\begin{aligned}
dl^2
&= dS^2 + dC^2 \\
&=
...
one can find that
%
\begin{equation}\label{eqn:modernOpticsLecture6:350}
\theta = \frac{\pi}{2} w^2.
\end{equation}
%
\end{enumerate}
...
%
\begin{equation}\label{eqn:modernOpticsLecture6:430}
I
= \Abs{\Psi}^2
...
%
\begin{equation}\label{eqn:modernOpticsLecture6:450}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture6Fig5}{Diffraction spectrum with partial blockage above line of sight (brutally rough illustration).}{fig:modernOpticsLecture6:modernOpticsLecture6Fig5}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture6Fig6}{Poisson spot.}{fig:modernOpticsLecture6:modernOpticsLecture6Fig6}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture6Fig7}{Diffraction grating (imagined to have been constructed to focus x-rays).}{fig:modernOpticsLecture6:modernOpticsLecture6Fig7}{0.2}
%
