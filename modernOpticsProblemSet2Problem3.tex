...
\end{subequations}
%
Let's write for the disk radius \(R\), distance from the disk \(D\), separation of the observation points \(d\).  We'll place the observation points in the plane of the disk, symmetrically separated around the normal to the disk from the centre
