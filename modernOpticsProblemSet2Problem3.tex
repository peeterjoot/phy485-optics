...
\end{subequations}
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig1}{Geometry for solar disk interference problem.}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig1}{0.2}
%
We have
%
...
we have
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:410}
\gamma_{12}
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:430}
I
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:490}
\calV = \frac
{
I_{\mathrm{max}}
- I_{\mathrm{max}}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig3}{Sinc like first order Bessel function.}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig3}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:510}
d
...
%
% J_1 plot, unused:
%For The behavior of this Bessel function as plotted in \cref{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig2} will drive the visibility
%\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig2}{Bessel \(J_1\).}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig2}{0.2}
%
...
%
%\imageFigure{../figures/phy485-optics/wikipediaPlanksBlack_body}{Plank's law distributions.}{fig:Black_body:wikipediaPlanksBlack_body}{0.2}
%
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:530}
\Psi_1 = \sqrt{I_0} e^{i (\overbar{\omega} - \Delta \omega) t}.
\end{equation}
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:550}
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:570}
...
so that
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:590}
\begin{aligned}
\gamma
&= \expectation{ e^{ -2 i \Delta \omega t - i \overbar{\omega} \tau} } \\
&= e^{- i \overbar{\omega} \tau } \expectation{ e^{ -2 i \Delta \omega t } } \\
&= e^{- i \overbar{\omega} \tau } \inv{2 \tau_a} \int_{-\tau_a}^{\tau_a} e^{ -2 i \Delta \omega t } dt \\
&= e^{- i \overbar{\omega} \tau } \inv{2 \tau_a} \frac{\sin(2 \Delta \omega \tau_a)}{\Delta \omega } \\
...
Our intensity is
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:610}
I
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig4}{Possible fringes from two sources at the boundaries of the spectral width.}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig4}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOptics:ProblemSet2:P3:630}
