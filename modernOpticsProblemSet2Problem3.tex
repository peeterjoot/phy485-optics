...
\end{subequations}
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig1}{Geometry for solar disk interference problem}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig1}{0.3}
...
%
\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig3}{Sinc like first order Bessel function}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig3}{0.3}
...
%\imageFigure{../figures/phy485-optics/modernOpticsProblemSet2Problem3Fig2}{Bessel \(J_1\)}{fig:modernOpticsProblemSet2Problem3:modernOpticsProblemSet2Problem3Fig2}{0.3}
...
%
%\imageFigure{../figures/phy485-optics/wikipediaPlanksBlack_body}{Plank's law distributions}{fig:Black_body:wikipediaPlanksBlack_body}{0.3}
%
