...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture16:30}
u_\omega = \Hbar \omega \expectation{ n_\omega } \calD(\omega).
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture16:50}
\expectation{ n_\omega } = \inv{ e^{\Hbar \omega / k T} - 1}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture16:70}
...
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture16:110}
...
%
\begin{equation}\label{eqn:modernOpticsLecture16:130}
\begin{aligned}
u_\omega
&=
\frac{A N_e}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture16:150}
\frac{A}{B_{\mathrm{se}}} =\frac{\Hbar \omega^3}{\pi^2 c^3}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture16:170}
...
%
\begin{equation}\label{eqn:modernOpticsLecture16:190}
...
so that
%
\begin{equation}\label{eqn:modernOpticsLecture16:210}
...
With
%
\begin{equation}\label{eqn:modernOpticsLecture16:230}
\begin{aligned}
\frac{A}{B}
...
so
%
\begin{equation}\label{eqn:modernOpticsLecture16:250}
