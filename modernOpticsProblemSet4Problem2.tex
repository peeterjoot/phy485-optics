...
\end{dmath}
or
\begin{dmath*}\label{eqn:modernOpticsProblemSet4Problem2:n}
\begin{bmatrix}
...
This question was posed in terms of Gaussian beams, which transform according to the M\"obius transformation, whereas we've considered only ray transformations.  We can relate the two considering the transformation of the waist at the \(z = 0\) point in the centre of the cavity.  Recall that we have
%
