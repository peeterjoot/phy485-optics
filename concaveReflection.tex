...
%
\imageFigure{../figures/phy485-optics/concaveReflectionFig1}{Concave spherical reflector.}{fig:concaveReflection:concaveReflectionFig1}{0.2}
%
...
%
or
\begin{equation}\label{eqn:concaveReflection:30}
...
%
we have
\begin{equation}\label{eqn:concaveReflection:110}
\begin{aligned}
\frac{r - s'}{\sqrt{s^2 + y^2}} \sin\theta_2
&=
