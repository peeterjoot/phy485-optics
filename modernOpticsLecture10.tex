...
%
\begin{equation}\label{eqn:modernOpticsLecture10:10}
...
%
\begin{equation}\label{eqn:modernOpticsLecture10:30}
\gamma_{12} = \calF \{ I(\omega) \}.
\end{equation}
%
when
%
\begin{equation}\label{eqn:modernOpticsLecture10:50}
\gamma_{12} = \gamma(\tau).
\end{equation}
%
and
%
\begin{equation}\label{eqn:modernOpticsLecture10:70}
\tau = \frac{s_2 - s_1}{c}.
\end{equation}
%
Example in \cref{fig:modernOpticsLecture10:modernOpticsLecture10Fig1}.
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig1}{Intensity example.}{fig:modernOpticsLecture10:modernOpticsLecture10Fig1}{0.2}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture10:90}
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig3}{\(\alpha_{12}\) illustrated.}{fig:modernOpticsLecture10:modernOpticsLecture10Fig3}{0.2}
%
Resulting in a non-zero \(\alpha_{12}\) as in \cref{fig:modernOpticsLecture10:modernOpticsLecture10Fig4}.
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig4}{Non zero \(\alpha_{12}\).}{fig:modernOpticsLecture10:modernOpticsLecture10Fig4}{0.2}
%
As opposed to \cref{fig:modernOpticsLecture10:modernOpticsLecture10Fig5}.
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig5}{Zero \(\alpha_{12}\).}{fig:modernOpticsLecture10:modernOpticsLecture10Fig5}{0.2}
%
where the figure had been drawn with \(\alpha_{12} = 0\).

Now suppose we rewrite things as:
%
\begin{equation}\label{eqn:modernOpticsLecture10:110}
I =
\Abs{\gamma_{12}}
\mathLabelBox{
\left(
...
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture10:130}
\left\{
\begin{array}{l l}
...
%
\begin{equation}\label{eqn:modernOpticsLecture10:150}
...
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig7b}{Filtered source without spectral distribution.}{fig:modernOpticsLecture10:modernOpticsLecture10Fig7b}{0.2}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig7c}{Intensity for distributed source.}{fig:modernOpticsLecture10:modernOpticsLecture10Fig7c}{0.15}
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig7d}{Intensity for filtered source.}{fig:modernOpticsLecture10:modernOpticsLecture10Fig7d}{0.15}
%
...
%
\imageFigure{../figures/phy485-optics/modernOpticsLecture10Fig8}{Spatially distributed source.}{fig:modernOpticsLecture10:modernOpticsLecture10Fig8}{0.2}
%
Here what is \(\Gamma_{12}\)?  Recall that
%
\begin{equation}\label{eqn:modernOpticsLecture10:170}
...
%
If are kilometres away from the light bulb, the spatial distribution of this source will not matter.

We will find that
%
\begin{equation}\label{eqn:modernOpticsLecture10:190}
\Gamma_{12} \rightarrow 0,
\end{equation}
%
over distance
%
\begin{equation}\label{eqn:modernOpticsLecture10:210}
\inv{\Delta k} = l_{\mathrm{tc}},
\end{equation}
%
or
\begin{equation}\label{eqn:modernOpticsLecture10:230}
\frac{\lambda}{\Delta \theta} = l_{\mathrm{tc}}.
\end{equation}
%
i.e. there's only spatial properties here being considered.  Writing things out
%
\begin{equation}\label{eqn:modernOpticsLecture10:250}
\begin{aligned}
\Gamma_{12}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture10:270}
\Gamma_{12}^a = \sqrt{I_1 I_2} \Abs{\gamma_{12}^a} e^{-i\omega \tau_a}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture10:290}
...
where
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture10:310}
\tau_a \equiv \frac{r_{1a} - r_{2a}}{c}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture10:330}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture10:370}
\Gamma_{12}^a = \sqrt{I_1 I_2} e^{-i\omega \tau_a}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture10:390}
...
%
\begin{equation}\label{eqn:modernOpticsLecture10:430}
\Abs{r} \gg \Abs{r_1^a - r_2^a} \quad \mbox{etc.}.
\end{equation}
%
We are left with
%
\begin{equation}\label{eqn:modernOpticsLecture10:450}
\gamma_{12} =
\inv{2} \gamma_{12}^a
+\inv{2} \gamma_{12}^b
=
...
%
\begin{equation}\label{eqn:modernOpticsLecture10:470}
\gamma_{12} = \cos\left(
