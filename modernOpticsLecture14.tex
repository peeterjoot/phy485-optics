...
%
\begin{equation}\label{eqn:modernOpticsLecture14:10}
\frac{\Delta \omega}{\overbar{\omega}} = \inv{ m \calF }.
\end{equation}
%
Here \(m = \text{order of interference}\) so
%
\begin{equation}\label{eqn:modernOpticsLecture14:30}
\Delta = m 2 \pi.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture14:50}
...
%
\begin{subequations}
\begin{equation}\label{eqn:modernOpticsLecture14:70}
L = 10 \text{cm} \rightarrow \text{RST} = 10^{10} \text{s}^{-1} \text{or} 1.5 \text{GHz}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture14:90}
R = 97 \% \rightarrow F = 100
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture14:110}
\overbar{\lambda} \sim 0.6 \mu m \rightarrow \text{visible light}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture14:130}
\overbar{\omega} = 3 \times 10^{15} \text{s}^{-1}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture14:150}
\overbar{\nu} = 500 \text{THz}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture14:170}
\frac{\Delta \omega}{\overbar{\omega}} = 3 \times 10^{-8}.
\end{equation}
\begin{equation}\label{eqn:modernOpticsLecture14:190}
...
We've got
%
\begin{equation}\label{eqn:modernOpticsLecture14:250}
\frac{I}{I_0} = \inv{
...
%
\begin{equation}\label{eqn:modernOpticsLecture14:270}
\Delta = 2 \pi m + \eta.
\end{equation}
%
\begin{equation}\label{eqn:modernOpticsLecture14:290}
\eta \ll 1.
\end{equation}
%
In terms of \(\delta = \omega - \omega_m\)
%
\begin{equation}\label{eqn:modernOpticsLecture14:310}
\eta = \frac{2 L}{c} \delta.
\end{equation}
%
(because \(\Delta = \frac{2 L}{c} \omega + \text{offset}\)), we are left with
%
\begin{equation}\label{eqn:modernOpticsLecture14:330}
\frac{I}{I_0}
= \inv{
...
if
%
\begin{equation}\label{eqn:modernOpticsLecture14:370}
