...
%
\begin{equation}\label{eqn:modernOpticsLecture1:10}
\begin{bmatrix}
y \\
\alpha
\end{bmatrix}
...
\begin{equation}\label{eqn:modernOpticsLecture1:30}
\begin{bmatrix}
y_f \\
\alpha_f
\end{bmatrix}
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:35}
\tan \alpha = \frac{\Delta y}{L} \approx \alpha,
\end{equation}
%
so that
%
\begin{equation}\label{eqn:modernOpticsLecture1:45}
y' = y + \Delta y \approx y + L \alpha,
\end{equation}
%
so that our matrix describing free propagation is
%
\begin{equation}\label{eqn:modernOpticsLecture1:50}
\begin{bmatrix}
y_f \\
\alpha_f
\end{bmatrix}
...
where
%
\begin{equation}\label{eqn:modernOpticsLecture1:70}
n \sin\alpha = n' \sin\alpha'.
\end{equation}
%
We employ the paraxial approximation
%
\begin{equation}\label{eqn:modernOpticsLecture1:90}
n \alpha \sim n' \alpha',
\end{equation}
%
or
%
\begin{equation}\label{eqn:modernOpticsLecture1:110}
\alpha' = \frac{n'}{n} \alpha,
\end{equation}
%
allowing for the description of refraction off of a flat lens by
%
\begin{equation}\label{eqn:modernOpticsLecture1:130}
\begin{bmatrix}
y_f \\
\alpha_f
\end{bmatrix}
...
we see that
%
\begin{equation}\label{eqn:modernOpticsLecture1:150}
\phi \approx \frac{y}{R},
\end{equation}
%
and can also employ Snell's law in the approximation
%
\begin{equation}\label{eqn:modernOpticsLecture1:370}
n \theta = n' \theta'.
\end{equation}
%
...
%
or
\begin{equation}\label{eqn:modernOpticsLecture1:390}
n(\alpha + \phi) = n' (\alpha' + \phi).
\end{equation}
%
Using \eqnref{eqn:modernOpticsLecture1:150} this is
\begin{equation}\label{eqn:modernOpticsLecture1:390b}
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:170}
\begin{bmatrix}
y_f \\
\alpha_f
\end{bmatrix}
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:170b}
\begin{bmatrix}
y_f \\
\alpha_f
\end{bmatrix}
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:190}
\begin{bmatrix}
y_f \\
\alpha_f
\end{bmatrix}
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:530}
M
=
\begin{bmatrix}
1 & 0 \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:550}
\frac{n'}{n} \rightarrow n,
\end{equation}
%
effectively working with \(n = 1\) outside of the lens.  This gives us
%
\begin{equation}\label{eqn:modernOpticsLecture1:570}
\begin{aligned}
M
&=
\begin{bmatrix}
...
&=
\begin{bmatrix}
1 + \frac{t \lr{ \inv{n} -1 }}{R_1} & \frac{t}{n} \\
\frac{ n -1  }{R_2}
- \frac{ n -1  }{R_1}
+
\frac{t \lr{ n -1 }}{R_1 R_2}
\lr{ \inv{n} -1  } &
\frac{t \lr{ -\inv{n} + 1 }}{R_2} + 1
\end{bmatrix} \\
&=
\begin{bmatrix}
1 + \frac{t \lr{ \inv{n} -1 }}{R_1} & t \inv{n} \\
-\lr{ n - 1  }
\lr{
\inv{R_1} -\inv{R_2}
+
\frac{t}{n R_1 R_2}\lr{ n - 1  }
}
&
1 - \frac{t \lr{ \inv{n} - 1 }}{R_2}
\end{bmatrix}
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:590}
\inv{f} =
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:210}
M =
\begin{bmatrix}
1 & 0 \\
- 1/f & 1
...
%
\begin{equation}\label{eqn:modernOpticsLecture1:230}
