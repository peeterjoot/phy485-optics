...
\makeoproblem{Fraunhofer diff., 4 circles.}
...
\imageFigure{../figures/phy485-optics/optics2010ExamFraunhoferFig2}{Four circular apertures.}{fig:optics2010ExamFraunhofer:optics2010ExamFraunhoferFig2}{0.2}
} % makeoproblem
...
\imageFigure{../figures/phy485-optics/optics2010ExamFraunhoferFig1}{Four apertures with observation point and distances.}{fig:optics2010ExamFraunhofer:optics2010ExamFraunhoferFig1}{0.2}
As usual we write
\begin{subequations}
\begin{equation}\label{eqn:optics2010ExamFraunhofer:20}
\BR = \Br' - \Br_s.
\end{equation}
\begin{equation}\label{eqn:optics2010ExamFraunhofer:40}
R
=
...
so that
%
\begin{equation}\label{eqn:optics2010ExamFraunhofer:60}
...
%
\begin{subequations}
\begin{equation}\label{eqn:optics2010ExamFraunhofer:80}
\rcap \cdot \xcap = \alpha.
\end{equation}
\begin{equation}\label{eqn:optics2010ExamFraunhofer:100}
\rcap \cdot \ycap = \beta,
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:optics2010ExamFraunhofer:120}
g(x, y) =
\left\{
\begin{array}{l l}
...
\begin{equation}\label{eqn:optics2010ExamFraunhofer:140}
\begin{aligned}
\Psi(\Br')
&=
...
\cos( k \alpha b/ 2 ) \cos( k \beta b/2 ) \times \\
&\qquad \int_{\rho=0}^R \int_{\theta = 0}^{2 \pi}
\rho d\rho d\theta
...
\begin{equation}\label{eqn:optics2010ExamFraunhofer:160}
\begin{aligned}
\Psi 
&\sim
\frac{e^{i k r'}}{r'}
...
%
\imageFigure{../figures/phy485-optics/optics2010ExamFraunhoferFig3}{Plot of \(J_1(x)/x\).}{fig:optics2010ExamFraunhofer:optics2010ExamFraunhoferFig3}{0.2}
%
We can also solve for the case when \(\alpha = \beta\), because we can write
%
\begin{equation}\label{eqn:optics2010ExamFraunhofer:180}
...
%
\begin{equation}\label{eqn:optics2010ExamFraunhofer:170}
\begin{aligned}
\Psi 
&\sim
\frac{e^{i k r'}}{r'}
...
%
\begin{equation}\label{eqn:optics2010ExamFraunhofer:200}
\Psi \sim
\frac{e^{i k r'}}{r'}
\cos( k \alpha b/ 2 )
...
\end{equation}
%
The hypergeometric function itself looks fairly sinc like, but not with the \(R^2\) multiplicative factor (plotted as a function of \(R\)).  This is plotted in \cref{fig:optics2010ExamFraunhofer:optics2010ExamFraunhoferFig4}, but curiously, this appears to be a divergent function?  On the exam, I expect that the expectation was just to look on axis, but it would probably also be useful to plug in some actually representative numbers.
%
\imageFigure{../figures/phy485-optics/optics2010ExamFraunhoferFig4}{Plot of hypergeometric function.}{fig:optics2010ExamFraunhofer:optics2010ExamFraunhoferFig4}{0.2}
} % makeanswer
