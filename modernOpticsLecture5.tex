...
\begin{equation}\label{eqn:modernOpticsLecture5:10}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:50}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:70}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:90}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:430}
\begin{aligned}
R
&= \sqrt{\BR^2} \\
&= \sqrt{ (\Br - \Br')^2 } \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:110}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:130}
\Psi(\Br) = -\inv{4\pi} \int da' \frac{e^{i k R}}{R} \left(
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:150}
\Psi(\Br') = \frac{e^{i k R_s }}{R_s}.
\end{equation}
%
where
%
\begin{equation}\label{eqn:modernOpticsLecture5:170}
\spacegrad' \Psi'
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:130b}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:190}
\begin{aligned}
\Psi(\Br)
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:210}
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:230}
\Psi(\Br)
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:270}
k f
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:290}
\Psi(\Br)
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:305}
g(\Br') =
\left\{
\begin{array}{l l}
1 & \quad \mbox{open} \\
...
%
\begin{equation}\label{eqn:modernOpticsLecture5:310}
\Psi(\Br)
...
so that
%
\begin{equation}\label{eqn:modernOpticsLecture5:330}
\Psi = (\text{constant}) G(\Bk_s - \Bk).
\end{equation}
%
where
%
\begin{equation}\label{eqn:modernOpticsLecture5:350}
G(\Bk) = \iint e^{-i \Bk \cdot \Br'} g(\Br') d^2 \Br',
\end{equation}
%
which is just a Fourier transform!  Our amplitude is
%
\begin{equation}\label{eqn:modernOpticsLecture5:370}
I(\Br) = \Abs{\Psi(\Br)}^2 = (\text{constant})^2 \Abs{G(\Bk_s - \Bk)}^2.
\end{equation}
%
Note that if the amplitude
%
\begin{equation}\label{eqn:modernOpticsLecture5:390}
\Abs{\Psi(\Br')} = \Psi_0.
\end{equation}
%
then this constant is
%
\begin{equation}\label{eqn:modernOpticsLecture5:410}
